...
[![k8s](https://img.shields.io/badge/k8s-v1.26.1-blue?style=for-the-badge)](https://kubernetes.io/)
[![Talos](https://img.shields.io/badge/Talos-v1.3.2-blue?style=for-the-badge)](https://talos.dev "Talos OS")
[![Cluster](https://status.chestr.dev/api/badge/1/uptime/24?style=for-the-badge&color=blue&label=uptime&labelSuffix=)](https://status.chestr.dev "Uptime")
