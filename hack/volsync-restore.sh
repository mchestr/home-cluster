...
task volsync:restore RSRC=appdaemon CLAIM=appdaemon-config-v1 NAMESPACE=home
task volsync:restore RSRC=esphome CLAIM=esphome-config-v1 NAMESPACE=home
task volsync:restore RSRC=home-assistant CLAIM=home-assistant-config-v1 NAMESPACE=home
task volsync:restore RSRC=zigbee2mqtt CLAIM=zigbee2mqtt-config-v1 NAMESPACE=home
task volsync:restore RSRC=zwavejs2mqtt CLAIM=zwavejs2mqtt-config-v1 NAMESPACE=home
task volsync:restore RSRC=radicale CLAIM=radicale-data-v1 NAMESPACE=home
task volsync:restore RSRC=unifi CLAIM=unifi-data-v1 NAMESPACE=home
task volsync:restore RSRC=zigbee2mqtt CLAIM=zigbee2mqtt-config-v1 NAMESPACE=home
task volsync:restore RSRC=zwavejs2mqtt CLAIM=zwavejs2mqtt-config-v1 NAMESPACE=home
